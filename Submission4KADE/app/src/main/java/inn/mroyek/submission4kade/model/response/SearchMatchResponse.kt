package inn.mroyek.submission4kade.model.response
...
data class EventSearch(
    ...
    fun transfromSearch() : Search {
        return Search(
            id = null,
            sportStr = this.strSport,
            eventId = this.idEvent,
            homeTeamId = this.idHomeTeam,
            awayTeamId = this.idAwayTeam,
            homeTeamStr = this.strHomeTeam,
            awayTeamStr = this.strAwayTeam,
            homeScoreInt = this.intHomeScore,
            awayScoreInt = this.intAwayScore,
